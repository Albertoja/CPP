...
/*   Updated: 2023/06/20 19:19:06 by aespinos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(std::string const name, int sgrade, int egrade, std::string const target) : _name(name), _sgrade(sgrade), _egrade(egrade), _signed(false), _target(target)
{
